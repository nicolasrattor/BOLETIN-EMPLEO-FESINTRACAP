...
writexl::write_xlsx(base,"INE PT/ocupados asalariados privados y publicos ENE formales mas de 5.xlsx")


# Lo mismo pero ahora con IC vía survey package
datos<-base %>% mutate(pt_low=NA,pt_upp=NA)
...
plot(datos$pt,type = "l")

writexl::write_xlsx(datos,"INE PT/ocupados asalariados privados y publicos ENE formales mas de 5 con IC.xlsx")
