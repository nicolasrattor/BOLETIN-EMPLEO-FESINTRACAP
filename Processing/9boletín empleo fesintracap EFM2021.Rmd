...
> La recuperación de la ocupación en el sector es clara desde junio, pero la mayor parte de esta recuperación se explica por la recuperación del empleo informal. En el sector informal, desde junio de 2020 hasta la fecha se crearon 33.238 puestos de trabajo, mientras que en el formal estos han aumentado en poco más de 4.000.
...
![Número de trabajadoras de casa particular ocupadas desde 2010 a 2021. Total, puertas adentro y puertas afuera](../Output/Gráficos/Gráfico1_EFM2021.png)
...
![Número de trabajadoras de casa particular formales e informales entre 2018 y 2021](../Output/Gráficos/Gráfico2_EFM2021.png)
