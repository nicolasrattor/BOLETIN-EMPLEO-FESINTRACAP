...
> La recuperación de la ocupación en el sector es clara desde junio 2020, pero la mayor parte de esta recuperación se explica por la recuperación del empleo informal. En el sector informal, desde junio de 2020 hasta la fecha se crearon 23.065 puestos de trabajo, mientras que en el formal estos han aumentado en cerca de 14.445. Desde febrero 2021 la ocupación de las formales ha ido aumentado progresivamente, mientras que la de las informales ha ido disminuyendo. 
...
ggsave(plot = g1,
  filename = "../Output/Gráficos/Gráfico1_MAM2021.png",
  device = "png",
  dpi = "retina",
  units = "cm",
  width = 30,
...
![Número de trabajadoras de casa particular ocupadas desde 2010 a 2021. Total, puertas adentro y puertas afuera](../Output/Gráficos/Gráfico1_MAM2021.png)
...
g2<-inf %>%
  ...
  labs(x="Tiempo",
       y = "Trabajadoras",
       caption = "Elaboración propia en base a Encuesta Nacional de Empleo del INE") +
  geom_text_repel(aes(label=ifelse(trimestre%in%c("Mar - May","Jul - Sep"), 
                                   format(round(trabajadores), big.mark = ".", scientific = FALSE),"")),
                  vjust=-0.4, colour = "black", size=6.0)

ggsave(plot = g2,
  filename = "../Output/Gráficos/Gráfico2_MAM2021.png",
  device = "png",
  dpi = "retina",
  units = "cm",
  width = 30,
...
![Número de trabajadoras de casa particular formales e informales entre 2018 y 2021](../Output/Gráficos/Gráfico2_MAM2021.png)
