...
g1<-mam %>%
  ...
  geom_text_repel(aes(label=ifelse(trimestre=="Oct - Dic", format(round(trabajadores), big.mark = ".", scientific = FALSE),"")),
            vjust=-3,colour="black")

ggsave(plot = g1,
  filename = "../Output/Gráficos/Gráfico1_OND.png",
  device = "png",
  dpi = "retina",
  units = "cm",
  width = 35,
...
![Número de trabajadoras de casa particular ocupadas desde 2010 a 2020. Total, puertas adentro y puertas afuera](../Output/Gráficos/Gráfico1_OND.png)
...
g2<-inf %>%
  ...
  labs(x="Tiempo",
       y = "Trabajadoras",
       caption = "Elaboración propia en base a Encuesta Nacional de Empleo del INE") +
  geom_text_repel(aes(label=ifelse(trimestre%in%c("Oct - Dic","Feb - Abr"), format(round(trabajadores), big.mark = ".", scientific = FALSE),"")),
                  vjust=-3,colour="black")

ggsave(plot = g2,
  filename = "../Output/Gráficos/Gráfico2_OND.png",
  device = "png",
  dpi = "retina",
  units = "cm",
  width = 35,
