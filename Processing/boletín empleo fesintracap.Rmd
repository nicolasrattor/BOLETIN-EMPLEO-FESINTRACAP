...
![Número de trabajadoras de casa particular ocupadas desde 2010 a 2020. Total, puertas adentro y puertas afuera](../Output/Gráficos/Gráfico1_ASO.png)
...
g2<-inf %>%
  ...
  labs(x="Tiempo",
       y = "Trabajadoras",
       caption = "Elaboración propia en base a Encuesta Nacional de Empleo del INE") +
  geom_text_repel(aes(label=ifelse(trimestre%in%c("Ago - Oct","Ene - Mar"), format(round(trabajadores), big.mark = ".", scientific = FALSE),"")),
                  vjust=-3,colour="black")

ggsave(plot = g2,
  filename = "../Output/Gráficos/Gráfico2_ASO.png",
  device = "png",
  dpi = "retina",
  units = "cm",
  width = 35,
...
![Número de trabajadoras de casa particular formales e informales entre 2018 y 2020](../Output/Gráficos/Gráfico2_ASO.png)
